...
public class WWWCHOTOTVN extends BaseDomain {
    ...
    public WWWCHOTOTVN()
            throws Exception {
        this.FILE_CONFIG = "crawl-plugins/chotot.vn.txt";
    }
    ...
    public String getLocation() {
        try {
            ...
            if ((params != null) && (params.length == 2)) {
                ...
                if (elements != null) {
                    if (elements.size() == 3) {
                        return ((Element) elements.get(1)).getTextExtractor().toString();
                    }
                    return ((Element) elements.get(2)).getTextExtractor().toString();
                }
            }
        } catch (Exception ex) {
    ...
    public long getPrice() {
        try {
            ...
            if ((params != null) && (params.length == 2)) {
                ...
                if (element != null) {
                    String content = element.getFirstElement("td").getTextExtractor().toString();
