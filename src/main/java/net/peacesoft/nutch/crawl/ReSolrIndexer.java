...
public class ReSolrIndexer extends Configured implements Tool {

    public static Logger LOG = LoggerFactory.getLogger(ReSolrIndexer.class);

    public ReSolrIndexer() {
        super(null);
    }

    public ReSolrIndexer(Configuration conf) {
        super(conf);
    }
    ...
    public static void main(String[] args) throws Exception {
        final int res = ToolRunner.run(NutchConfiguration.create(), new ReSolrIndexer(), args);
        System.exit(res);
    }
}
