 ...
 *
 */
public class ReGenerator extends Configured implements Tool {

    public static final Logger LOG = LoggerFactory.getLogger(ReGenerator.class);
    ...
    public static class Selector implements
        ...
        public void map(Text key, CrawlDatum value,
            ...
            if (intervalThreshold != -1 && crawlDatum.getFetchInterval() > intervalThreshold) {
                return;
            }
    ...
    public ReGenerator(Configuration conf) {
        setConf(conf);
    }
    ...
    public Path[] generate(Path dbDir, Path segments, int numLists, long topN,
        ...
        try {
            ...
            if ("true".equals(getConf().get(GENERATE_MAX_PER_HOST_BY_IP))) {
                LOG.info("ReGenerator: GENERATE_MAX_PER_HOST_BY_IP will be ignored, use partition.url.mode instead");
            }
            ...
            LOG.info("ReGenerator: finished at " + sdf.format(end) + ", elapsed: " + TimingUtil.elapsedTime(start, end));
    ...
    private Path partitionSegment(FileSystem fs, Path segmentsDir, Path inputDir,
        ...
        if (LOG.isInfoEnabled()) {
            LOG.info("ReGenerator: Partitioning selected urls for politeness.");
        }
    ...
    public static void main(String args[]) throws Exception {
        int res = ToolRunner.run(NutchConfiguration.create(), new ReGenerator(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        try {
            ...
            LOG.error("ReGenerator: " + StringUtils.stringifyException(e));
            return -1;
        }
        return 0;
    }
