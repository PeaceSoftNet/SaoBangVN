 ...
 * accordingly.
 */
public class ReCrawlDb extends Configured implements Tool {

    public static final Logger LOG = LoggerFactory.getLogger(ReCrawlDb.class);
    ...
    public ReCrawlDb(Configuration conf) {
        setConf(conf);
    }
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(NutchConfiguration.create(), new ReCrawlDb(), args);
        System.exit(res);
    }
