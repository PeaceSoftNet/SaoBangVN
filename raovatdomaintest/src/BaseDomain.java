...
public class BaseDomain
    ...
    protected String USER_AGENT = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.64 Safari/537.11";//Mozilla/5.0 (Windows NT 6.1; rv:12.0) Gecko/20120403211507 Firefox/12.0";
    ...
    public void parse(String url) throws Exception {
        ...
        if (base.getHost().contains("timviecnhanh.com") || base.getHost().contains("tuyendungvieclam.vn")) {
            this.source = getSourceBy(new CURL(base, this.isSOCK5));
//        } else if (base.getHost().contains("http://mangtimviec.com/")) {
//            this.source = getSourceBy(new CURL(base, false));
        } else {
