...
public class SAIGONOTOVN extends BaseDomain {

    public SAIGONOTOVN()
            throws Exception {
        this.FILE_CONFIG = "crawl-plugins/saigonoto.vn.txt";
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = "http://saigonoto.vn/sell_view.php?id=307";
//        url = "http://saigonoto.vn/sell.php?categoryid=21";
        
        SAIGONOTOVN saigonoto = new SAIGONOTOVN();
        saigonoto.setConf(conf);
        saigonoto.parse(url);
        
        String[] tmp = saigonoto.getCategory();
        if (tmp != null) {
            System.out.println(tmp[0] + " - " + tmp[1]);
        }
        
        System.out.println(saigonoto.getLocation());
        System.out.println(saigonoto.getTitle());
        System.out.println(saigonoto.getMobile());
        System.out.println(saigonoto.getPrice());
        System.out.println(saigonoto.getEmail());
        //System.out.println(
        //        StringEscapeUtils.unescapeHtml(choxevietcom.getContent()));
        Outlink[] links = saigonoto.getOutlinks();
