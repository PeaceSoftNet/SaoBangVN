...
public class WWWCAREERLINKVN extends BaseDomain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WWWCAREERLINKVN muabancomvn = new WWWCAREERLINKVN();
        muabancomvn.setConf(conf);
        muabancomvn.parse(url);
        String[] tmp = muabancomvn.getCategory();
        System.out.println(tmp[0] + " - " + tmp[1]);
        System.out.println(muabancomvn.getLocation());
        System.out.println(muabancomvn.getTitle());
        System.out.println(muabancomvn.getMobile());
        System.out.println(muabancomvn.getEmail());
    }
}