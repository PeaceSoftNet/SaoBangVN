 ...
 */
public class CUNGCAUOTOCOM extends BaseDomain {

    public CUNGCAUOTOCOM()
            throws Exception {
        this.FILE_CONFIG = "crawl-plugins/cungcauoto.com.txt";
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = "http://cungcauoto.com/buysell/mod/detail/catid/1/id/1089/can-ban-honda-civic-18-mt-doi-2011mau-trang.html";

        CUNGCAUOTOCOM cungcauoto = new CUNGCAUOTOCOM();
        cungcauoto.setConf(conf);
        cungcauoto.parse(url);
        String[] tmp = cungcauoto.getCategory();
        if (tmp != null) {
            System.out.println(tmp[0] + " - " + tmp[1]);
        }
        System.out.println(cungcauoto.getLocation());
        System.out.println(cungcauoto.getTitle());
        System.out.println(cungcauoto.getMobile());
        System.out.println(cungcauoto.getPrice());
        System.out.println(cungcauoto.getEmail());
        //System.out.println(
        //        StringEscapeUtils.unescapeHtml(choxevietcom.getContent()));
        Outlink[] links = cungcauoto.getOutlinks();
