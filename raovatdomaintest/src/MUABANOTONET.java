 ...
 */
public class MUABANOTONET extends BaseDomain {

    public MUABANOTONET()
            throws Exception {
        this.FILE_CONFIG = "crawl-plugins/muabanoto.net.txt";
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = "http://muabanoto.net/oto/kia/morning/kia-morning-2012-5614.html";
        url = "http://muabanoto.net/oto/honda/";

        MUABANOTONET muabanoto = new MUABANOTONET();
        muabanoto.setConf(conf);
        muabanoto.parse(url);

        String[] tmp = muabanoto.getCategory();
        if (tmp != null) {
            System.out.println(tmp[0] + " - " + tmp[1]);
        }

        System.out.println(muabanoto.getLocation());
        System.out.println(muabanoto.getTitle());
        System.out.println(muabanoto.getMobile());
        System.out.println(muabanoto.getPrice());
        System.out.println(muabanoto.getEmail());
        //System.out.println(
        //        StringEscapeUtils.unescapeHtml(choxevietcom.getContent()));
        Outlink[] links = muabanoto.getOutlinks();
